...
export class PhaseComponentResponseApiModel implements Omit<
  AllowlistComponent,
  'items' | 'winners' | '_insertionOrder'
> {
  @ApiProperty({
    description: 'ID',
  })
  ...
  @ApiProperty({
    description: 'Number of winners wallets in the component.',
  })
  readonly winnersWalletsCount: number;

  @ApiProperty({
    description: 'Number of winners spots in the component.',
  })
